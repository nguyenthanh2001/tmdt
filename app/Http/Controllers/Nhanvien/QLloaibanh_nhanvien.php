...
class QLloaibanh_nhanvien extends Controller
{
    ...
    // }
    public function getloaibanh_nhanvien(Request $request)
    {
        ...
        return view('nhanvien.loaibanh', compact('ad_lb'));
    }
    ...
    public function get_edit_loaibanh($id, Request $request)//sua banh, show tt loai banh
    {
        ...
        return redirect()->route('nhanvien.getloaibanh_nhanvien');
    }
    ...
    public function get_delete_loaibanh($id)
    {
        ...
        return redirect()->route('nhanvien.get-edit-loaibanh');
    }
}
