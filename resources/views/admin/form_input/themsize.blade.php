        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Size Bánh" name="tensize" required>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1" class="font-weight-bold">Tên bánh</label>
                    <input type="text" class="form-control tags" placeholder="Thêm tên bánh" name="tenbanh" required>
