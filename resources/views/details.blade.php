                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            ...
                            @foreach ($detail->anhct as $itemImg)
                                <img data-imgbigurl="{{ asset('upload/imgCakes/' . $itemImg->link) }}"
                                    src="{{ asset('upload/imgCakes/' . $itemImg->link) }}" alt="">
                            @endforeach
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="row col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                                    ...
                                    @foreach ($price['giabanh'] as $detailItem)
                                        @if (isset($detailItem['giagiam']))
                                            <button type="button" data-giagiam="{{ $detailItem['giagiam'] }}"
                                                ...
                                                class="btn btn-outline-primary m-1 btnPrice" value="{{$detailItem['masize']}}">Size
                            ...
                            {{-- co giam gia --}}
                                <div class="product__details__price" data-giamgia='{{$price['giabanh'][0]['giagiam']}}' data-giagoc='{{$price['giabanh'][0]['giagoc'] }}' data-price="{{$price['giabanh'][0]['giagiam']}}" >
                                    <del>{{ $price['giabanh'][0]['giagoc'] }} VND</del>
                                    <span class="ml-1">{{ $price['giabanh'][0]['giagiam'] }} VND</span>

                                </div>
                            @else        
                                <div class="product__details__price" data-giagoc='{{$price['giabanh'][0]['giagoc'] }}' data-price="{{$price['giabanh'][0]['giagoc'] }}">{{ $price['giabanh'][0]['giagoc'] }} VND</div>                              
                            @endif
                        ...
                        @if (isset($price['giabanh'][0]['tensize']))                   
                        <input type="hidden" name="masize" value="{{$price['giabanh'][0]['masize']}}" id="masize" readonly required>
                        @endif                    
