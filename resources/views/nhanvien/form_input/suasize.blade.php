        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="tensize" placeholder="Size hải sản" name="tensize" required>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1" class="font-weight-bold">Tên Hải sản</label>
                    <input type="text" class="form-control tags" id="tenbanh" placeholder="Thêm tên hải sản" name="tenbanh" required>
